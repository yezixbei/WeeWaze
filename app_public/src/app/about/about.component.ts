...
export class AboutComponent implements OnInit {
  public pageContent = {
    ...
    content: `WeeWaze is a project to search, visualize, and verify traffic patterns from private companies using availble but underutilized data from public agencies. \n
